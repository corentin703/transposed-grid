...
| `nonGroupSectionHeight`        | `non-group-section-height`        |             | `string \| undefined`                                                                                                                                                                                                                                                                 | `undefined` |
| `primaryKey`                   | `primary-key`                     |             | `string \| undefined`                                                                                                                                                                                                                                                                 | `undefined` |
| `rows`                         | --                                |             | `Row[] \| undefined`                                                                                                                                                                                                                                                                  | `undefined` |
| `scrollableGroupSectionHeight` | `scrollable-group-section-height` |             | `string \| undefined`                                                                                                                                                                                                                                                                 | `undefined` |
